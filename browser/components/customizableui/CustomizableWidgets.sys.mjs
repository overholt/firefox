...
ChromeUtils.defineLazyGetter(lazy, "qrcodeLog", () => {
...
export const CustomizableWidgets = [
  ...
  },
  {
    id: "qrcode-button",
    type: "view",
    viewId: "PanelUI-qrcode",
    l10nId: "toolbar-button-qrcode",
    async onViewShowing(aEvent) {
      ...
      let body = document.createXULElement("vbox");
      body.className = "panel-subview-body";
      body.style.minWidth = "332px";
      body.style.padding = "16px";

      // Create loading message
      let loadingLabel = document.createXULElement("label");
      loadingLabel.textContent = "Generating QR code...";
      ...
      try {
        ...
        image.style.margin = "0 auto 16px auto";
        ...
        urlLabel.style.marginBottom = "16px";
        ...
        lazy.qrcodeLog.error("Failed to generate QR code:", e);
        while (body.firstChild) {
          body.firstChild.remove();
        }
